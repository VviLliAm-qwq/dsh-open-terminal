...
const STRINGS: Record<Lang, Record<string, string>> = {
    zh: {
        ...
        hintLinux: '请安装任一终端模拟器（gnome-terminal / konsole / xfce4-terminal / kitty / alacritty / wezterm / xterm…），或用配置 command 指定终端',
    ...
    en: {
        ...
        hintLinux: 'install a terminal emulator (gnome-terminal / konsole / xfce4-terminal / kitty / alacritty / wezterm / xterm …), or set `command` to the terminal you want',
